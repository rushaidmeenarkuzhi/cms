             ...
             <div class="row">
                ...
                <div class="col-md-10">
                    <main class="main-content">
                        <div class="position-relative iq-banner mt-2">
                                            ...
                                            <table class="table table-striped align-middle">
                                                ...
                                                <tbody>
                                                    @foreach($customer as $cust)
                                                        <tr>
                                                            <td>{{ $cust->name }}</td>
                                                            <td>{{ $cust->ticket_id }}</td>
                                                            <td><a href="{{ route('complaint.showassign',$cust->ticket_id) }}">Assigned To Technician</a></td>
                                                        <td>
                                                            @if($cust->status === 'assigned')
                                                                <span class="badge bg-success">Assigned</span>
                                                            @elseif($cust->status === 'pending')
                                                                <span class="badge bg-warning text-dark">Pending</span>
                                                            @elseif($cust->status === 'resolved')
