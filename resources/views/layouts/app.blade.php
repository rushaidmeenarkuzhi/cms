...
<head>
    ...
    <link href="{{ asset('assets/css/core/libs.min.css') }}" rel="stylesheet" />

    <!-- Aos Animation Css -->
    <link href="{{ asset('assets/vendor/aos/dist/aos.css') }}" rel="stylesheet" />

    <!-- Hope Ui Design System Css -->
    <link href="{{ asset('assets/css/hope-ui.min.css?v=2.0.0') }}" rel="stylesheet" />

    <!-- Custom Css -->
    <link href="{{ asset('assets/css/custom.min.css?v=2.0.0') }}" rel="stylesheet" />

    <!-- Dark Css -->
    <link href="{{ asset('assets/css/dark.min.css') }}" rel="stylesheet" />

    <!-- Customizer Css -->
    <link href="{{ asset('assets/css/customizer.min.css') }}" rel="stylesheet" />
