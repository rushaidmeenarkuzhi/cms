        ...
        <div class="sidebar-list">
            ...
            <ul class="navbar-nav iq-main-menu" id="sidebar-menu">
             @if(auth()->user()->user_type == 1)
                ...
                <li class="nav-item">
                    <a class="nav-link {{ Str::contains(Route::currentRouteName(), 'complaints') ? 'active':''}}" href="{{ route('complaints.index') }}">
                        <i class="icon">
                        ...
                        <span class="item-name"> Customer Complaint </span>
                    </a>
                </li>
                ...
                <li class="nav-item">
                    <a class="nav-link {{ Str::contains(Route::currentRouteName(), 'technician_list') ? 'active':''}}" href="{{ route('technician_list.index') }}">
                        <i class="icon">
                            <svg class="icon-20" width="20" viewBox="0 0 24 24" fill="none"
                                xmlns="http://www.w3.org/2000/svg">
                                <path opacity="0.4"
                  ...
                  <li class="nav-item">
                    <a class="nav-link {{ Str::contains(Route::currentRouteName(), 'user') ? 'active' : '' }}" href="{{ route('user.index') }}">
                        <i class="icon">
                            <svg class="icon-20" width="20" viewBox="0 0 24 24" fill="none"
                                xmlns="http://www.w3.org/2000/svg">
                                <path
